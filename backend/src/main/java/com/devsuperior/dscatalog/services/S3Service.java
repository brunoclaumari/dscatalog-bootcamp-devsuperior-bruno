...
public class S3Service {
	...
	public URL uploadFile(MultipartFile file) {
		try {
			...
			// fileName é o nome que será salvo no S3 da amazon
	...
	private URL uploadFile(InputStream iStream, String fileName, String contentType) {
		ObjectMetadata meta = new ObjectMetadata();
		meta.setContentType(contentType);
		LOG.info("Upload start");
		s3client.putObject(bucketName, fileName, iStream, meta);
